...
export function StandardModal({ visible, onClose, children, footer }: StandardModalProps) {
      ...
      <View style={styles.contentContainer}>
        ...
        <BottomSheetScrollView
          ...
          contentContainerStyle={[
            ...
            footer && styles.scrollViewContentWithFooter
          ]}
...
const styles = StyleSheet.create({
  ...
  scrollViewContentWithFooter: {
    paddingBottom: 100, // Отступ для фиксированной панели
  },
  footerContainer: {
    position: 'absolute',
    bottom: 0,
